...
local javierPos = Vector(1062.250732, 1111.711792, 0.031250)
...
function QUEST:OnComplete()
	quest.giveToPlayer( self:GetPlayer(), "quest1.4" )
end
...
QUEST.hidden = true
QUEST.description = "Arcanine appears."

local javierPos = Vector(1062.250732, 1111.711792, 0.031250)
local arcaninePos = Vector(734.954346, 422.813354, 0.031250)
...
function QUEST:Init()
	...
	self.arcanine = self:RegisterNPC( "arcanine", self.ControlArcanine, function(npc)
		npc:SetPos( arcaninePos )
	end )
...
function QUEST:ControlArcanine( arcanine )
end
